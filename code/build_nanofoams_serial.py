"""
##################################################
 build_nanofoams_serial.py - Última modificación 5/11/21
 
## Parámetros para pasar por línea de comandos: input_file.txt 
## Ejemplo:
    # python build_nanofoams.py input_file.txt
## Devuelve:
...
for i,batch in enumerate(point_batches):
    ...
    print(f'Batch {i}/{len(point_batches)}')
